...
-- --------------------------------------------------------------------
-- 17. TABLE: dkm_surat_menyurat (Manajemen Surat Menyurat DKM)
-- --------------------------------------------------------------------
...
CREATE POLICY "Allow All Surat Menyurat" ON public.dkm_surat_menyurat FOR ALL TO public, anon, authenticated USING (true) WITH CHECK (true);
GRANT ALL ON TABLE public.dkm_surat_menyurat TO anon, authenticated, service_role;

-- Storage Bucket untuk Aset, Bukti Donasi & Dokumen Surat
